...
> [!NOTE]
> **First-Time Users**: Initial usage might prompt for permission to use "JavaScript via AppleScript" (_or something similair: I'd appreciate receiving a screenshot for mentioning the correct text here!_). If you'd prefer not accept his, consider substituting 
>
>```AppleScript
